...
nethack_conf_snap_files=('snap/.nethackrc')
...
codex_conf_repo_folders=('app/codex/skills')
...
gitui_conf_snap_folders=('snap/.config/gitui')
gitui_conf_repo_folders=('app/gitui')
